        ...
        <GridContainer>
          <div className={styles.footer_left}>
            <div className={styles.footer_left_top}>
              <Text Comp={'h2'} weight="semibold" transform="uppercase" size={130}>
                CONTACTS
              </Text>
              <div className={styles.footer_left_top_paragraph}>
                <Text Comp={'p'} size={20} transform="uppercase" weight="normal" color="white">
            ...
            <div className={styles.footer_left_bottom}>
              <div className={styles.footer_left_bottom_item}>
                ...
                <Text Comp={'p'} size={18} transform="uppercase" weight="normal" color="white">
          ...
          <div className={styles.footer_right}>
            <div className={styles.footer_right_inner}>
              <Text Comp={'h2'} weight="semibold" transform="uppercase" size={60}>
